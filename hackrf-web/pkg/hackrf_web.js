...
export class DspProcessor {
     ...
     */
    get_iq_output_len() {
        const ret = wasm.dspprocessor_get_iq_output_len(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    get_output_len() {
        const ret = wasm.dspprocessor_get_output_len(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     * @returns {number}
     */
    process_iq_only_ptr(iq_ptr, num_iq_bytes) {
        const ret = wasm.dspprocessor_process_iq_only_ptr(this.__wbg_ptr, iq_ptr, num_iq_bytes);
        return ret >>> 0;
    }
    /**
     ...
     * @returns {number}
     */
    process_ptr(iq_ptr, num_iq_bytes) {
        const ret = wasm.dspprocessor_process_ptr(this.__wbg_ptr, iq_ptr, num_iq_bytes);
        return ret >>> 0;
    }
    /**
...
export class FFT {
     ...
     * @returns {number}
     */
    fft_ptr(iq_ptr, num_iq_bytes) {
        const ret = wasm.fft_fft_ptr(this.__wbg_ptr, iq_ptr, num_iq_bytes);
        return ret >>> 0;
    }
    /**
